...
# From Wikipedia. Centripetal Catmull-rom chain. 
...
def catmull_rom_chain(points: tuple, num_points: int, is3d: bool = False) -> list:
    """
    ...
    all_splines = (catmull_rom_spline(*pq, num_points, is3d=is3d) for pq in point_quadruples)
